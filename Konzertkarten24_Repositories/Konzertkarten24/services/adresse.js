...
serviceRouter.post("/adresse", function(request, response) {
    ...
    else if (helper.isUndefined(request.body.ort)) {
    ...
    const adresseDao = new AdresseDao(request.app.locals.dbConnection);
    try {
        var result = adresseDao.create(request.body.strasse, request.body.plz, request.body.ort);
...
serviceRouter.put("/adresse", function(request, response) {
    ...
    const adresseDao = new AdresseDao(request.app.locals.dbConnection);
    try {
        var result = adresseDao.update(request.body.id, request.body.strasse, request.body.plz, request.body.ort);
